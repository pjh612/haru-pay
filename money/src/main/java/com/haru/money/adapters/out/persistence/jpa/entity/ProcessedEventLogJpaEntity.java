...
@Table(name = "money_processed_event_log", uniqueConstraints = {
        @UniqueConstraint(name = "uk_money_processed_event_log_consumer_event", columnNames = {"consumer_key", "event_id"})
})
